...
class UserAccountController extends Controller
{
    ...
    public function save(Request $request)
    {
        ...
        return response()->json(["msg" => __('Your account successfully added.'), "msg_title" => __('Account Added')]);
    }
    ...
    public function update($hash, Request $request)
    {
        ...
        return response()->json(["reload" => 1500, "msg" => __('The account successfully updated.'), "msg_title" => __('Account Updated')]);
    }
