...
<div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body modal-body-md">
            <h4 class="title">{{ blank($userAccount) ? __('Add BTC Wallet') : __('Update BTC Wallet') }}</h4>
            @if(blank($userAccount))
            <p>{{ __('Add your BTC Wallet address to withdraw your funds.') }}</p>
            @else 
            <p>{{ __('Update your existing BTC Wallet for future withdraw.') }}</p>
            @endif
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" name="wdm-email" value="{{ data_get($userAccount, 'config.email') }}" class="form-control form-control-lg" id="paypal-email" placeholder="{{ __('Enter wallet address') }}">                                    
                                    </div>
                                </div>
                            </div>
