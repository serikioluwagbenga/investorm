<?php 
    header("Location: https://mintcapitalfx.com/");
    exit();
?>
                ...
                <div class="pricing card card-shadow h-100 is-dark round-lg text-center">
                    <div class="card-inner card-inner-lg h-100 d-flex flex-column">
                        ...
                        <ul class="pricing-feature">
                            ...
                            <li>
                                <span class="label">{{ __('Term Duration') }}</span> Payment processors we accept
                        ...
                        <div class="pricing-action mt-auto">
                            @if (!auth()->check())
                            <a class="btn btn-primary btn-lg btn-block" href="https://app.primestarstrading.com/dashboard/deposits">{{ __("Make a deposit") }}</a>
                            @else
                            <a class="btn btn-primary btn-lg btn-block" href="https://app.primestarstrading.com/dashboard/buy-plan">{{ __("Invest Now") }}</a>
                            @endif
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="pricing card card-shadow h-100 round-lg text-center">
                    <div class="card-inner card-inner-lg h-100 d-flex flex-column">
                        ...
                        <div class="pricing-action mt-auto">
                            @if (!auth()->check())
                            <a class="btn btn-light btn-lg btn-block" href="https://app.primestarstrading.com/dashboard/deposits">{{ __("Make a deposit") }}</a>
                            @else
                            <a class="btn btn-light btn-lg btn-block" href="https://app.primestarstrading.com/dashboard/buy-plan">{{ __("Invest Now") }}</a>
                            @endif
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-gs">
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="card card-shadow text-center h-100">
                            ...
                            <div class="card-inner py-2 border-top mt-auto">
                                <a class="link" href="https://app.primestarstrading.com/dashboard/deposits">{{ __("Create an account") }}</a>
                            </div>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="{{ (auth()->check()) ? 'col-md-6' : 'col-md-4 col-sm-6' }}">
                        <div class="card card-shadow text-center h-100">
                            ...
                            <div class="card-inner py-2 border-top mt-auto">
                                @if (!auth()->check())
                                <a class="link" href="https://app.primestarstrading.com/dashboard/deposits">{{ __("Make a deposit") }}</a>
                                @else
                                <a class="link" href="https://app.primestarstrading.com/dashboard/deposits">{{ __("Make a deposit") }}</a>
                                @endif
                            </div>
                    ...
                    <div class="{{ (auth()->check()) ? 'col-md-6' : 'col-md-4' }}">
                        <div class="card card-shadow text-center h-100">
                            ...
                            <div class="card-inner py-2 border-top mt-auto">
                                @if (!auth()->check())
                                <a class="link" href="https://app.primestarstrading.com/dashboard/deposits">{{ __("Withdraw profits") }}</a>
                                @else
                                <a class="link" href="https://app.primestarstrading.com/dashboard/withdrawals">{{ __("Withdraw profits") }}</a>
                                @endif
                            </div>
                        </div>
                    </div>
                ...
                <div class="card card-shadow text-center h-100">
                    <div class="card-inner card-inner-lg my-auto">
                        <div class="card-text my-lg-n2">
                            ...
                            <p>{{ (gss('extra_step4_text')) ? __(gss('extra_step4_text')) : __("We accept cryptocurrencies such as Bitcoin and Ethereum.") }}</p>
                            @php 
                            $accepted_icons = gss('extra_step4_icons', ['sign-btc', 'sign-eth']); 
                            @endphp
                            ...
                            <div class="payment-action">
                                @if (!auth()->check())
                                <a href="https://app.primestarstrading.com/dashboard/deposits" class="btn btn-lg btn-primary btn-block"><span class="text-wrap">{{ __("Join now") }} {{ __("and") }} {{ __("make deposit") }}</span></a>
                                @else
                                <a class="btn btn-lg btn-primary btn-block" href="https://app.primestarstrading.com/dashboard/deposits">{{ __("Make a deposit") }}</a>
                                @endif
                            </div>
                        </div>
                    </div>
