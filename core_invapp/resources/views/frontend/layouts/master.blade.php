                    ...
                    <div class="header-wrap">
                        ...
                        <nav class="header-menu"  data-content="main-hmenu">
                            <ul class="menu-list ml-lg-auto">
                                ...
                                <li class="menu-item"><a href="https://app.primestarstrading.com/dashboard/buy-plan" class="menu-link nav-link">{{ __("Investment") }}</a></li>
                                @endif
                                {!! Panel::navigation('mainnav') !!}

                                @if (!auth()->check() && gss('signup_allow', 'enable') == 'enable')
                                <li class="menu-item"><a href="https://app.primestarstrading.com/register" class="menu-link nav-link">{{ __("Register") }}</a></li>
                                @endif
                            </ul>
                            <ul class="menu-btns">
                                <li>
                                    <a href="https://app.primestarstrading.com/login" class="btn btn-round btn-primary"><em class="icon ni ni-user-alt"></em> <span>{{ __("Login") }}</span></a>
                                </li>
                            </ul>
