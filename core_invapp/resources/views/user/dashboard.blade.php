...
<div class="nk-content-body">
    <div class="nk-block-head nk-block-head-sm">
       ...
       <div class="nk-block">
        <div class="alert alert-primary bg-white alert-thick">
            <div class="alert-cta flex-wrap flex-md-nowrap g-2">
                <div class="alert-text has-icon">
                    <em class="icon ni ni-report-fill text-primary"></em>
                    <p class="text-base"><strong>{{ __("Note") }}:</strong> {{ 'Users are advised to make weekly withdrawals' }}</p>
                </div>
            </div>
        </div>
    </div>
